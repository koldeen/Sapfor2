...
//   12 "parallel regions %shave common function '%s' which is used inside this regions"
//   13 "parallel regions %shave local array '%s' which is used inside this regions"
//   14 "parallel region '%s' has common array '%s' which is used inside and outside region"
//   15 "parallel region '%s' does not have interval for fragment"
//   16 "expected only assign operands in interval"
//   17 "parallel region '%s' does not have copying of array '%' in interval"
//   18 "parallel region '%s' does not have copying of common array '%' in interval"
