...
//--- FREE
//1028
static const wchar_t *R62 = L"Описание модуля '%s' должено находиться в данном файле";
//1029
//--- TODO
//1030
//--- TODO
...
//1041
static const wchar_t *R74 = L"Область распараллеливания '%s'содержит строку, которая включеная в другую область";
//1042
...
static const wchar_t *R77 = L"Неверное выражение в директиве: ожидается %d тесновложенных циклов на строке %d, но их всего %d";
...
//2002
static const wchar_t *R96 = L"Арефметический IF был преобразован в IF-ENDIF";
...
//2005
static const wchar_t *R100 = L"Циклы на строках %в и %d были объединены";
//2006
...
//3002
static const wchar_t *R109 = L"Добавлен приватный скаляр '%s' к циклу на строке %d";
//3003
...
static const wchar_t *R122 = L"Надены различные правила выравнивания массивов, используемых на запись в данном цикле препятствует распараллеливанию";
...
//3009
static const wchar_t *R129 = L"Добаленный REMOTE_ACCESS для обращения к массиву '%s' может привести к сильному замедлению";
//3010
static const wchar_t *R130 = L"Не обнаружены массивы или свободные циклы для распределения в данном преокте";
...
//3013
static const wchar_t *R134 = L"Области распараллеливания %sимеют общий используемый локальный массив";
//3014
