...
void createFunctionsAndArrays(std::vector<ParallelRegion*> &regions, const std::map<std::string, std::vector<FuncInfo*>> &allFuncInfo, const std::map<std::string, FuncInfo*> &funcMap, const std::set<std::string> &allCommonFunctions, const std::set<std::string> &allUsedCommonArrays);
void replaceFunctionsAndArrays(const std::vector<ParallelRegion*> &regions, const std::map<std::string, std::vector<FuncInfo*>> &allFuncInfo, const std::map<std::string, FuncInfo*> &funcMap, const std::set<std::string> &allCommonFunctions);
void insertArraysCopy(const std::vector<ParallelRegion*> &regions, const std::map<std::string, std::vector<FuncInfo*>> &allFuncInfo, const std::map<std::string, FuncInfo*> &funcMap);
